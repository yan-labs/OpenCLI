...
export class Page extends CDPBasePage {
  ...
  constructor(
    ...
    private readonly windowMode?: 'foreground' | 'active' | 'background' | 'isolated',
  ...
  private _sessionOpts(): { session: string; surface: 'browser' | 'adapter'; idleTimeout?: number; contextId?: string; preferredContextId?: string; windowMode?: 'foreground' | 'active' | 'background' | 'isolated'; siteSession?: 'ephemeral' | 'persistent' } {
    return {
